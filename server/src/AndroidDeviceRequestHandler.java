...
public class AndroidDeviceRequestHandler extends Thread {
    ...
    public AndroidDeviceRequestHandler(Socket deviceSocket, DataInputStream dataInputStream, DataOutputStream dataOutputStream) {
